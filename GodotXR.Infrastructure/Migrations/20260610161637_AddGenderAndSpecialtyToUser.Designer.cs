...
namespace GodotXR.Infrastructure.Migrations
{
    ...
    [Migration("20260610161637_AddGenderAndSpecialtyToUser")]
    partial class AddGenderAndSpecialtyToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GodotXR.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 10, 16, 16, 37, 46, DateTimeKind.Utc).AddTicks(8382),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 6, 10, 16, 16, 37, 46, DateTimeKind.Utc).AddTicks(8386),
                            Description = "Teacher",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Teacher"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 6, 10, 16, 16, 37, 46, DateTimeKind.Utc).AddTicks(8387),
                            Description = "Parent",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Parent"
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 6, 10, 16, 16, 37, 46, DateTimeKind.Utc).AddTicks(8388),
                            Description = "Child",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Child"
