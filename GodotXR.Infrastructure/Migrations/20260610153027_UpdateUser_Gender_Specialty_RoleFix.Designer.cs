...
namespace GodotXR.Infrastructure.Migrations
{
    ...
    [Migration("20260610153027_UpdateUser_Gender_Specialty_RoleFix")]
    partial class UpdateUser_Gender_Specialty_RoleFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GodotXR.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 10, 15, 30, 27, 31, DateTimeKind.Utc).AddTicks(1827),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 6, 10, 15, 30, 27, 31, DateTimeKind.Utc).AddTicks(1831),
                            Description = "Teacher",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Teacher"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 6, 10, 15, 30, 27, 31, DateTimeKind.Utc).AddTicks(1833),
                            Description = "Parent",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Parent"
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 6, 10, 15, 30, 27, 31, DateTimeKind.Utc).AddTicks(1834),
                            Description = "Child",
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "Child"
